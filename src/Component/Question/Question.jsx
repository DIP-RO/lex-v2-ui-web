...
const Question = () => {
    <Loading/>
    return (
        <div className="hero min-h-fit my-10 sm:hidden bg-[#f5f1f1]">
            <div className="hero-content flex-col gap-10 lg:flex-row-reverse md:flex-row-reverse">
                ...
                <div className="w-full md:w-1/2">
                    <h1 className="text-5xl font-bold text-black">Any Question?</h1>
                    <p className="py-6 text-black">Feel free to contact with us. We are available 24/7</p>
                    <p className="pb-6 text-2xl font-semibold text-black">You can reach us through:</p>
