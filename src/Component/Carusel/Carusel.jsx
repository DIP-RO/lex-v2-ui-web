    ...
    return (
        <div className="carousel w-full sm:hidden ">
            <div id="slide1" className="carousel-item relative w-full">
                <div className=" w-full  bg-[#212222] flex ">
                    <div className="w-1/2 justify-center items-center">
                       ...
                       <h1 className="text-center text-4xl font-['Open_Sans'] font-bold text-white mt-10 ">{t("Home.Banner.first.title")}</h1>
                        ...
                        <Link to="/Lex-Ai">
                        <button className="btn btn-neutral justify-center lg:ml-40 bg-[#212222] w-[332px]  h-10  text-center rounded-[25px] mt-10" >{t("Home.Banner.first.btn")}</button>
                        </Link>
                       </div>
                    </div>
            ...
            <div className=" w-full h-96 bg-[#212222] flex ">
                    <div className="w-1/2 justify-center items-center">
                       <div className="justify-center mt-16">
                       <h1 className="text-center text-4xl font-['Open_Sans'] font-bold text-white mt-10 ">{t("Home.Banner.second.title")}</h1>
                        ...
                        <Link to="/appointment">
                        <button className="btn btn-neutral justify-center lg:ml-40 bg-[#212222] w-[332px]  h-10  text-center rounded-[25px] mt-10">{t("Home.Banner.second.btn")}</button>
                        </Link>
                       </div>
                    </div>
