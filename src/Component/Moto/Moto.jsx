...
const Moto = () => {
  ...
  <Loading />;
  return (
    <div className="grid lg:grid-cols-3  md:grid-cols-3 text-base sm:text-lg md:gap-5 lg:text-xl xl:text-2xl grid-cols-1 lg:gap-14 m-10  sm:hidden bg-[#191818]  px-10 py-5">
